...
process_video_to_csv('good_shoulder.mp4', 'Good Shoulder')
process_video_to_csv('bad_shoulder.mp4', 'Bad Shoulder')
process_video_to_csv('good_tricep.mp4', 'Good Tricep')
process_video_to_csv('bad_tricep.mp4', 'Bad Tricep')
